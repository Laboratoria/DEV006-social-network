export const register = () => {
    ...
    form.append(h2, userNameLabel, userName, lastNameLabel, lastName, birthdayLabel, birthday, doYouHavePetsLabel, checkAllergies, checkAnimalsLooking, profilePictureLabel, profilePictureInput, txtEmailLabel, txtEmail, spanErrorEmail, txtPasswordLabel, txtPassword, spanErrorPassword, txtPasswordAgainLabel, txtPasswordAgain, btnRegister);
    ...
    checkAllergies.append(brAllergies, petAllergyLabel, pollenAllergyLabel, dustAllergyLabel, moldAllergyLabel, insectAllergyLabel, foodAllergyLabel);
    ...
    checkAnimalsLooking.append(brPets, dogLabel, catLabel, hamsterLabel, rabbitLabel, parrotLabel, othersLabel);

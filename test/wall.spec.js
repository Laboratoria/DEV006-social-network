...
import { getPost } from '../src/lib/index.js';
...
//       uid: '1', // Simular el uid del usuario actual
//     },
//   }),
// }));
...
//   beforeEach(() => {
//     // Mock de getPost para proporcionar los datos necesarios
//     getPost.mockImplementation((callback) => {
//       const queryData = [
//         {
//           petName: 'Juan',
//           description: 'Perro lindo.',
//           username: 'Gabriela Porras',
//           uid: '123',
//         },
//       ];
//       callback(queryData);
